...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/kitti_models/KITTI_testset.yaml', help='specify the config for training')
    ...
    parser.add_argument('--eval_tag', type=str, default=None, help='eval tag for this experiment')
