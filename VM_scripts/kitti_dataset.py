...
class KittiDataset(DatasetTemplate):
    ...
    def get_lidar(self, idx):
        ...
        try:
            ...
            lidar_file_npy = self.root_split_path / 'velodyne' / ('%s.npy' % idx)
            return np.load(lidar_file_npy).astype(np.float32)
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        ...
        #from .kitti_object_eval_python import eval_kitti_clean_data_modified as kitti_eval
